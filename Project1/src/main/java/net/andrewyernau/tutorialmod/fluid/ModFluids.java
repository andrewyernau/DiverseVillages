...
public class ModFluids {
    ...
    public static final RegistryObject<FlowingFluid> FLOWING_SOAP_WATER=FLUIDS.register("soap_water_fluid",
    ...
    public static final ForgeFlowingFluid.Properties SOAP_WATER_FLUID_PROPERTIES=new ForgeFlowingFluid.Properties(
            ModFluidsTypes.SOAP_WATER_FLUID_TYPE,SOURCE_SOAP_WATER,FLOWING_SOAP_WATER).slopeFindDistance(2).levelDecreasePerBlock(2).block(ModBlocks.SOAP_WATER_BLOCK).bucket(ModItems.SOAP_WATER_BUCKET);
