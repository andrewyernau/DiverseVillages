package net.andrewyernau.tutorialmod.screen;
...
public class WizardTableMenu extends AbstractContainerMenu {
    ...
    public WizardTableMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.WIZARD_TABLE_MENU.get(), id);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.WIZARD_TABLE.get());
    }
